...
$doc->addScriptDeclaration('
    ...
    tree.root.load(\'index.php?option=com_schuweb_sitemap&task=navigator-links&sitemap='.$this->item->id.'&e_name='.$name.'&tmpl=component\');
    });
    ');
?>
